...
function Hero() {
    ...
    return (
        <div className="">
            ...
            <div className="flex items-center justify-center mt-14 gap-x-6 h-12">
                <button className="px-4 py-2 bg-sky-500 hover:bg-sky-400 text-white rounded-xl h-full">Get Started</button>
                <div className="flex space-x-4 rounded-xl items-center p-2 bg-slate-800 h-full ">
                    ...
                    <input onSubmit={handleSubmit} className="bg-transparent outline-none text-white" placeholder="Quick Search..." />
                    <p className="text-gray-200 px-2">Ctrl K</p>
                </div>
            </div>
        </div>
    )
